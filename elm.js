			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'background',
						_1: _awakeiningflame$awakeningflame$Responsive$isMobile(config.windowSize) ? 'linear-gradient(135deg, #271e3f 0%,#2c3277 52%,#1d005e 52%,#36174f 100%)' : 'linear-gradient(135deg, )url(\'images/bg.jpg\') no-repeat'
					},
...
var Elm = {};
Elm['Pages'] = Elm['Pages'] || {};
Elm['Pages']['Home'] = Elm['Pages']['Home'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Pages']['Home'], 'Pages.Home', typeof _awakeiningflame$awakeningflame$Pages_Home$main === 'undefined' ? null : _awakeiningflame$awakeningflame$Pages_Home$main);
